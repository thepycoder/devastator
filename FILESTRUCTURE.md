...
* C++ source files:
  * `include/devastator/devastator.hpp` is the main
    C++ header that declares the interface of your library.
  * `src/devastator.cpp` is the main file that implements this library.
  * `app/devastator_app.cpp` is an executable that uses the library.
    This can e.g. be used to provide a command line interface for your project.
  * `tests/devastator_t.cpp` contains the unit tests for the library.
